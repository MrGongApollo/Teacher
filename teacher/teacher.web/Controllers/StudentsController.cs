...
namespace teacher.web.Controllers
{
    ...
    public class StudentsController : BaseController
    {
        ...
        #region 获取学生成绩
        [HttpPost]
        public ActionResult GetStudentsScore(T_Score filter, string sortType, string orderBy, int offSet = 0, int pageSize = 10)
        {
            try
            {
                using (TeacherEntities context = new TeacherEntities())
                {
                    ...
                    sql += string.IsNullOrEmpty(filter.ExamID) ? "" : " AND ExamID='" + filter.ExamID + "'";
        ...
        /// 保存学生信息
        /// </summary>
        /// <param name="stu">学生成绩</param>
        /// <param name="operatype">操作类型</param>
        /// <returns></returns>
        [HttpPost]
        public ActionResult StudentsScoreSave(T_Students stu, string operatype)
        {
            KeyValueModel ret = base.error_r;
            try
            {
